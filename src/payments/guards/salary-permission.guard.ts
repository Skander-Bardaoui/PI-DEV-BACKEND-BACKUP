...
export const SALARY_PERMISSION_KEY = 'salaryPermission';

@Injectable()
export class SalaryPermissionGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const hasPermission = member.salary_permissions?.[requiredPermission] === true;
